...
1.) Schalte den automatischen Wechsel der Zeitzone in deinem Smartphone aus. 
2.) Wähle eine Zeitzone mit der gewünschten Zeit aber ohne Zeitumstellung. Für die Mitteleuropäische Zeit (MEZ) könnte dies z.B. "Brazzaville" (Kongo) sein. Stelle die Zeitzone deines Smartphones manuell auf Kongo. 
3.) Aktuallisiere die Pumpe via AndroidAPS. 
4.) Prüfe den Behandlungs Tab (BEH)... Falls Du doppelte Einträge entdeckst:
...
5.) Falls der Status unklar sein sollte: 
Pausiere den Loop für mindestens eine DIA (Insulin-Wirkdauer) oder Max-Carb-Time - je nach dem welche Zeitdauer größer ist.
